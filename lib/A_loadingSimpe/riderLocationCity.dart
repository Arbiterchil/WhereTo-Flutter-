...
class LocationRiderCity extends StatefulWidget {
  @override
  _LocationRiderCityState createState() => _LocationRiderCityState();
}

class _LocationRiderCityState extends State<LocationRiderCity> {
  String selectedCity;
  ...
  Widget build(BuildContext context) {
   return BackdropFilter(
    ...
    void navigatepage() async{ 
      ...
      UserGetPref().riderSaveCity(selectedCity);
      var data = {
        "userId":UserGetPref().getUserDataJson['id'],
        "cityId":selectedCity,
        "barangayId": UserGetPref().getUserDataJson['barangayId']
      };
      await ApiCall().postRemitRider(data, '/addCity');
