...
var filter =search.where((element) => element.menuName.toLowerCase().contains(query) || element.menuName.toUpperCase().contains(query) || 
element.restaurantName.toLowerCase().contains(query) || element.restaurantName.toUpperCase().contains(query) || element.categoryName.toLowerCase().contains(query) 
|| element.categoryName.toUpperCase().contains(query)).toList();
sinkMenu.add(filter);
}
